...
void writePPM(const std::string& filename, const std::vector<uint8_t>& pixels, const int& width, const int& height);

void exam3()
{
	const std::string filename = "example3.ppm"; // TODO : where is a better place to open a file?
